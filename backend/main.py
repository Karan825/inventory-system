...
def create_order(order: schemas.OrderCreate, db: Session = Depends(get_db)):
    ...
    # 2. Verify products and stock, calculate total
...
def delete_order(order_id: int, db: Session = Depends(get_db)):
    ...
    # Optional: Should deleting an order restore stock?
    # Business rules usually don't restore stock on delete, but on "cancel". 
    # For now, we just delete the order. Cascade delete handles order_items.
